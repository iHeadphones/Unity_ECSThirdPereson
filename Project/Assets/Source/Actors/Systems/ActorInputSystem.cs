...
public class ActorInputSystem : ComponentSystem
{
    ...
    private void UpdateAsPlayer(Entity entity, ref ActorInput actorInput)
    {
        ...
        //Get Player Input
        {
            ...
            //BUTTONS
            if (GInput.GetButtonDown(GButton.RIGHT)) actorInput.actionToDo = 1;
            if (GInput.GetButtonDown(GButton.BOTTOM)) actorInput.actionToDo = 2;
            if (GInput.GetButtonDown(GButton.LEFT)) actorInput.actionToDo = 3;
